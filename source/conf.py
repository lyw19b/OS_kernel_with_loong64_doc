...
# 文档作者，默认为 '龙芯中科技术有限公司'，默认根据中英文自动切换，显示在PDF封面以及内容页左下角
author = u'龙芯实验室'

# 版权信息，默认为 '2022-2026, 龙芯中科技术有限公司'，根据中英文自动切换
...
# PDF水印文本，默认为'Loongson Intelligence Confidential'
watermarktext = u'Loongson Laboratory Confidential'
...
# Sphinx主题，必填，不要修改
html_theme = 'sphinx_loongsonlab_theme'
