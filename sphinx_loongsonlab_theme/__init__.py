...
def setup(app: "Sphinx"):
    ...
    if python_version[0] < 3:
        logger.error("Python 2 is not supported with sphinx_loongsonlab_theme, update to Python 3.")
    ...
    app.add_config_value('watermarktext', u'Loongson Technology Confidential', 'env', [str])
    ...
    loongsonlab_locale_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'locale')
    app.add_message_catalog('sphinx', loongsonlab_locale_path)
    ...
    if builder_name == "html":
        ...
        if app.config.html4_writer:
            logger.error("'html4_writer' is not supported with sphinx_loongsonlab_theme.")
        ...
        app.add_html_theme('sphinx_loongsonlab_theme', os.path.abspath(os.path.dirname(__file__)))
